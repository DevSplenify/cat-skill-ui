...
import AvailabilityTabs from '../components/ui/Availability/AvailabilityTabs'
  ...
  return (
    <div>
      {!showRequestForm && (
        <>
          ...
          <div className="flex items-center gap-3 md:hidden mb-4">
            ...
            <div>
              <h2 className="text-xl font-medium text-gray-900">Find Availability</h2>
              <p className="text-xs" style={{ color: '#69686D' }}>Please Select a date and block to find available spots.</p>
            </div>
          </div>

          {/* Desktop header */}
          <div className="hidden md:block mb-6">
            <h2 className="text-xl font-medium" style={{ color: '#171A26' }}>Find Availability</h2>
            <p className="text-sm mt-1" style={{ color: '#69686D' }}>Please Select a date and block to find available spots.</p>
          </div>
        </>
      )}
      ...
      <AvailabilityTabs
        ...
        onHideRequestForm={() => setShowRequestForm(false)}
      />
    </div>
  )
}
